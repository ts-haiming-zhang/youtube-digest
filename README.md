...
3. Read the timestamped transcript, or choose **Original**, **English**, **双语（英）**, **中文**, **双语（中）**, **日本語**, or **2カ国語（日）**.
...
- Original, English, bilingual English, Simplified Chinese, bilingual Chinese, Japanese, and bilingual Japanese transcript views. Translation modes matching the original subtitle language are disabled.
