...
- 把零碎字幕变成清晰、可搜索的学习资料。
- 查看原文、英文翻译、原文加英文双语、简体中文翻译、原文加中文双语、日语翻译，或原文加日语双语字幕来学习语言。
...
3. 阅读带时间戳的字幕，或选择 **Original**、**English**、**双语（英）**、**中文**、**双语（中）**、**日本語** 或 **2カ国語（日）**。
...
- 原文、英文、英文双语、简体中文、中文双语、日语和日语双语字幕。与原字幕同语种的翻译模式会自动禁用。
